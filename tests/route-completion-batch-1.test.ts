...
describe('Manchester-Dubai\'s new fare observation matches the approved specification exactly', () => {
  ...
  it('Manchester-Dubai\'s historic entries remain untouched — further genuine observations were appended on 6, 18, 25 August and 1 September 2026', () => {
    ...
    const historic = dubaiObs.filter((o) => ![
      ...
      // 2026) — a fully-dated, fresh observation, not a historic entry.
  ...
  it('remains publishable alongside the 18 August, 25 August and 1 September 2026 refresh observations', () => {
