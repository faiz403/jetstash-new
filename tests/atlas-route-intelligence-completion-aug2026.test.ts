...
describe('Every data/routes.ts entry has a tracked Atlas Route Intelligence state', () => {
  ...
  it('sanity: the current 88-route catalogue grades 10 Strong / 78 Useful / 0 Expanding — after the Final Route-Guide Completion batch\'s two evidence passes added 8 Useful-graded routes', () => {
