...
describe('final audit round 3 — evidenceDetail replaces the old EVIDENCE_BUNDLE-derived evidence text', () => {
  ...
  it('cancellation produces no old airline/date/review claim anywhere, including evidenceDetail', () => {
    ...
    // manchester-lahore's real route.verification.verifiedDate is 2026-09-14 (refreshed by the 14 September 2026 Route Verification Maintenance batch, was previously 2026-08-14) — the citation's own checked date, independent of the (removed) withdrawal.
    expect(copy.evidenceDetail).toBe('Current route evidence checked 14 September 2026.');
  });
