...
export const destinations: Destination[] = [
  // Pakistan
  {
    ...
    familyVisitContent: {
      travelPattern:
        'Most Lahore-bound UK travellers are visiting relatives rather than holidaying. Trips run longer, with two to four weeks common, bookings cluster around Eid and weddings, and most people stay with family rather than in hotels.',
      documentNote:
      ...
      packingNote:
        'Excess baggage is the single most underestimated cost on this route, because gifts and shopping for the return leg routinely exceed standard allowances. Pre-purchasing extra baggage online at the time of booking is consistently cheaper than paying at the airport.',
  ...
  },
  {
    ...
    description:
      'Islamabad is the green, planned counterpoint to Pakistan\'s older cities, and a useful base for visiting family across Punjab and Khyber Pakhtunkhwa, with easy onward travel to the north.',
    ...
    familyVisitContent: {
      travelPattern:
        'Islamabad is frequently the arrival point for families with onward journeys into Khyber Pakhtunkhwa or northern Punjab, so the transfer logistics for that final leg matter as much as the flight itself.',
      documentNote:
  ...
  },
  {
    ...
    familyVisitContent: {
      travelPattern:
        'Karachi sees a mix of family-visit and business travel. Unlike Lahore or Islamabad, a meaningful share of UK travellers here come for commercial rather than purely family reasons, which shortens the typical trip.',
      documentNote:
  ...
  // India
  {
    ...
    familyVisitContent: {
      ...
      packingNote:
        'If your onward journey involves a domestic Indian flight, check the often stricter domestic baggage allowance separately from your international one. The two are frequently different, and it catches travellers out.',
