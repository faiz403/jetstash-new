...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    // Trust fix (10 Sept 2026, Astra bounded review; corrected same day,
    // founder review): "your bags are checked through" was stated as a
    // fact of booking on a single ticket. First pass said "one booking
    // generally means the airline owns the problem" — still risked reading
    // as if any single booking were a protected through-ticket. Narrowed to
    // name the protected through-ticket/protected-connection itinerary
    // specifically as what gives the airline that responsibility, keeping
    // the baggage outcome as a separate fact that depends on the actual
    // ticket/airline arrangement and needs confirming at booking.
    paragraphs: [
