...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'The years to watch are the ones where the two calendars collide. When Eid or Diwali falls inside a UK school holiday window, both demand spikes hit the same dates at once and fares are the steepest of the year — book earlier than either pattern alone would suggest. In years where the festival sits in normal term time, families tied to school dates and families tied to the festival are competing for different weeks, and pricing is noticeably kinder.',
      'Don\'t forget the return leg follows its own festival logic. Outbound demand peaks in the days before the festival; return demand peaks in the days immediately after it, when everyone who travelled out wants to come home in the same narrow window. If your dates have any flexibility at all, shifting the return even a few days past the post-festival rush is one of the more reliable ways to bring the total fare down.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Before paying, confirm the operator is ATOL-protected for flight-inclusive packages booked in the UK — it\'s what protects your money if the operator fails. And be realistic about Ramadan: it is the highest-demand period of the year, prices rise accordingly, and the walking-distance hotels sell out first. If Ramadan is the point of the trip, book early and fix the hotel details in writing; if it isn\'t, travelling either side of it buys noticeably more package for the same money.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Set it up before you leave, not after you land. Install the eSIM at home on your own Wi-Fi, confirm it appears as a second line, and read how activation works — some plans start the clock at install, others at first connection. Keep your UK SIM active but with data roaming off: your WhatsApp number stays your UK number regardless of which SIM provides the data, which is exactly what you want for staying reachable to family on both ends of the trip.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Three wording checks matter most on these routes. First, trip length: extended family stays often run past the per-trip day limit buried in annual policies. Second, pre-existing conditions: cover for older travellers is only valid if conditions were declared — an undeclared condition is the most common reason a large medical claim fails. Third, valuables: wedding and gift jewellery routinely exceeds the per-item limit on a standard policy, so check the cap before assuming it\'s covered in your luggage.',
      'Buy the policy when you book the trip, not when you fly. Cancellation cover starts from the purchase date — insurance bought the week before departure has spent months not protecting the money you\'d already committed. It\'s a detail that costs nothing to get right and is the difference between a refunded trip and a lost one if plans change.',
    ],
  },
  {
