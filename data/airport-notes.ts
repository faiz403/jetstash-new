...
export const airportNotes: AirportPracticalNote[] = [
  ...
  { id: 'lhr-terminal-confirm', airportSlug: 'london-heathrow', title: 'Terminal assignment varies by airline — always confirm', body: 'British Airways, Virgin Atlantic and Air India each operate from different terminals at Heathrow. A terminal mix-up here costs considerably more time than at a smaller regional airport given Heathrow\'s scale.' },
  ...
  { id: 'ema-short-haul-only', airportSlug: 'birmingham-east-midlands', title: 'Best treated as a short-haul and charter airport for this audience', body: 'Its real value for South Asia / Gulf-focused travellers is Mediterranean leisure travel, not the long-haul routes — always price-compare Birmingham and Manchester before booking a connecting itinerary from here.' },
  { id: 'lba-verify-direct-claims', airportSlug: 'leeds-bradford', title: "Verify any direct service claim before booking — don't assume one exists", body: 'Direct Leeds Bradford to Pakistan services have been announced and then failed to materialise more than once. Confirm directly with the airline\'s own booking system that a specific flight number and date genuinely exists before committing.' },
  ...
  { id: 'lpl-compare-manchester', airportSlug: 'liverpool', title: 'Always price-compare against Manchester before booking a connection here', body: 'Manchester is roughly 35–45 minutes away and has direct Pakistan and Gulf services. For long-haul, run both searches before assuming Liverpool is the cheaper or easier option.' },
  ...
  { id: 'ncl-dubai-gateway', airportSlug: 'newcastle', title: 'The direct Dubai service is a real Gulf gateway, not just a connection', body: "Emirates' daily Newcastle–Dubai flight runs in Economy, Premium Economy and Business Class — worth booking as a destination in its own right, not only as a stopover en route elsewhere." },
