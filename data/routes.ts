...
export const routes: Route[] = [
  ...
  },
  {
    ...
    frequency: 'Weekly direct — PK710 Manchester–Lahore (Fri departure) / PK709 Lahore–Manchester (Sat departure), Boeing 777, per converging press coverage; see note',
    airlineSlugs: ['pia'],
    isDirect: true,
    verification: {
      status: 'verified',
      sourceName: "Manchester Airport's own media centre (route still listed live, re-checked 14 September 2026, no suspension notice), corroborated by multiple independent Pakistani aviation-press outlets (ProPakistani, Profit/Pakistan Today, Daily Times, The Nation) reporting PIA's weekly PK709/PK710 Manchester–Lahore schedule",
      ...
      note: 'Route Verification Maintenance (14 September 2026, due-now batch): Manchester Airport\'s destination material still supports the direct PIA service, re-checked live this session. PIA\'s own site (piac.com.pk) returned a 403 to automated access this session, consistent with this airline\'s known bot-blocking pattern elsewhere in this file (e.g. Manchester–Karachi, Batch 3). In its place, this session found a genuine frequency upgrade over the 14 August check\'s "frequency not confirmed": multiple independent Pakistani aviation-press outlets (ProPakistani, Profit/Pakistan Today, Daily Times, The Nation, Daily Pakistan), reporting independently of each other, converge on a weekly PK709/PK710 Boeing 777 service (PK710 departs Manchester Friday, PK709 departs Lahore Saturday) operating since the 3 July 2026 launch. This is treated as corroborating secondary evidence for an operational fact the airline\'s own site could not be reached to confirm directly, not as a replacement for a primary source — matching this file\'s existing precedent for airline sites blocked to automated access. Classified RECENT/CHANGING (30-day window): a route still within its first year of operation.',
    },
  ...
  },
  {
    ...
    flightTime: 'Published direct service, approximately 2h; exact duration varies by flight', frequency: 'Multiple carriers confirmed operating direct, approximately 15 flights/week combined, per current schedule data — see note', airlineSlugs: ['easyjet'], isDirect: true,
    verification: { status: 'verified', sourceName: "Birmingham Airport's official destinations listing (403 to automated access this session — see note), corroborated by current third-party schedule aggregation naming Ryanair, Vueling and easyJet as operators", sourceUrl: 'https://airport.birminghamairport.co.uk/destinations/where-we-fly/', verifiedDate: '2026-09-14', reviewDueDate: '2026-12-13', note: 'Route Verification Maintenance (14 September 2026, overdue batch): Birmingham Airport\'s own destinations page returned a 403 to this session\'s automated access (a known pattern for this domain elsewhere in this file). In its place, current schedule-aggregation data (drawing on live airline booking data, not a static marketing page) independently confirms Ryanair (~11/week), Vueling (~5/week) and easyJet (~3/week) all operate this route direct today, with services running on multiple days (Mon/Wed/Fri/Sat/Sun). Ryanair and Vueling are not currently in the airline catalogue (data/airlines.ts), so only easyJet is added to public airlineSlugs — the other two are noted here only, matching this file\'s existing convention (e.g. birmingham-faro, birmingham-rome). Three named, currently-operating carriers with an established multi-weekly frequency and no volatility signal found supports STABLE (90-day window) rather than the prior thin-evidence RECENT/CHANGING treatment.' },
  ...
  },
  {
    ...
    flightTime: 'Approximately 2h 10m direct; check the exact flight for duration', frequency: 'easyJet and Vueling confirmed operating direct multiple times daily; British Airways also operates the route direct — see note', airlineSlugs: ['easyjet', 'british-airways'], isDirect: true,
    verification: { status: 'verified', sourceName: "London Gatwick's official destinations information, corroborated by current schedule data naming easyJet, Vueling and British Airways as operators with a specific dated easyJet flight example (15 September 2026)", sourceUrl: 'https://www.gatwickairport.com/flights/destinations.html', verifiedDate: '2026-09-14', reviewDueDate: '2026-12-13', note: 'Route Verification Maintenance (14 September 2026, overdue batch): Gatwick\'s own destinations page still lists Barcelona, re-checked live this session. Current schedule data independently names easyJet and Vueling as the primary operators, with British Airways also confirmed operating the route direct, and a specific bookable easyJet flight was found for 15 September 2026. easyJet and British Airways are both in JetStash\'s airline catalogue (data/airlines.ts) and are added to public airlineSlugs; Vueling is not currently catalogued, so it is noted here only, matching this file\'s existing convention. Multiple named, currently-operating carriers with a high daily frequency and no volatility signal found supports STABLE (90-day window).' },
  ...
  },
  {
    ...
    flightTime: 'Approximately 2h 5m direct; check the exact flight for duration', frequency: 'easyJet and Ryanair confirmed operating direct, approximately 20 flights/week combined, per current schedule data — see note', airlineSlugs: ['easyjet'], isDirect: true,
    verification: { status: 'verified', sourceName: "Bristol Airport's official explore-destinations listing, corroborated by current schedule data naming easyJet and Ryanair as operators", sourceUrl: 'https://www.bristolairport.co.uk/where-can-i-fly/explore-destinations/', verifiedDate: '2026-09-14', reviewDueDate: '2026-12-13', note: 'Route Verification Maintenance (14 September 2026, overdue batch): current schedule data independently confirms easyJet (~13/week) and Ryanair (~8/week) both operate this route direct today, September 2026. Ryanair is not currently in JetStash\'s airline catalogue (data/airlines.ts), so only easyJet is added to public airlineSlugs, matching this file\'s existing convention. Two named, currently-operating carriers with an established ~20/week combined frequency and no volatility signal found supports STABLE (90-day window).' },
  ...
  },
  {
    ...
    flightTime: 'Approximately 2h 55m direct; check the exact flight for duration', frequency: 'Jet2 and Ryanair confirmed operating direct, approximately 11 flights/week combined, per current schedule data — see note', airlineSlugs: ['jet2'], isDirect: true,
    verification: { status: 'verified', sourceName: "Jet2's own current Leeds Bradford–Faro booking page, corroborated by current schedule data also naming Ryanair", sourceUrl: 'https://www.jet2.com/en/cheap-flights/leeds-bradford/faro', verifiedDate: '2026-09-14', reviewDueDate: '2026-10-14', note: 'Route Verification Maintenance (14 September 2026, overdue batch): Leeds Bradford Airport\'s own direct-destinations list, re-checked live this session, no longer features Faro among its currently displayed "City Breaks"/"Beaches" categories — but the airport\'s own page states it "flies to 80+ destinations" and only showcases a curated subset, so this is read as a curation gap, not evidence the route stopped. Jet2\'s own current booking page for this exact city pair independently confirms live, bookable September 2026 flights, and current schedule data also names Ryanair as a second operator (~11/week combined). Ryanair is not currently in JetStash\'s airline catalogue (data/airlines.ts), so only Jet2 is added to public airlineSlugs, matching this file\'s existing convention. Two named, currently-operating carriers with an established weekly frequency would otherwise support STABLE, but this is deliberately kept on the shorter RECENT/CHANGING window (30 days) instead, given the airport\'s own curated list no longer surfacing this destination is a new, unexplained signal worth rechecking sooner than 90 days.' },
  ...
  },
  {
    ...
    flightTime: 'Approximately 3h 40m direct; check the exact flight for duration', frequency: 'easyJet confirmed operating direct, approximately 48 flights/week, per current schedule and its own live flight-tracker records (e.g. EZY8185/EZY8182) — see note', airlineSlugs: ['easyjet'], isDirect: true,
    verification: { status: 'verified', sourceName: "London Gatwick's official destinations information, corroborated by easyJet's own live flight-tracker pages for named flights on this route", sourceUrl: 'https://www.gatwickairport.com/flights/destinations.html', verifiedDate: '2026-09-14', reviewDueDate: '2026-12-13', note: 'Route Verification Maintenance (14 September 2026, overdue batch): Gatwick\'s own destinations page still lists Athens, re-checked live this session. Current schedule data independently confirms easyJet operates the route direct at high frequency (~48/week), and easyJet\'s own flight-tracker pages for named flights on this exact city pair (EZY8185 Gatwick–Athens, EZY8182 Athens–Gatwick) corroborate the airline is currently operating scheduled service. easyJet is added to public airlineSlugs (already in data/airlines.ts). A named, currently-operating carrier with a high weekly frequency and no volatility signal found supports STABLE (90-day window).' },
