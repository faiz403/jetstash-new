...
export const routes: Route[] = [
  ...
  },
  {
    ...
    verification: {
      status: 'unverified',
      sourceName: "Heathrow's own live flight-tracking pages for flights BG201 (Dhaka to London, arriving Terminal 4) and BG202 (London to Dhaka, departing Terminal 3), plus Heathrow's own airline-directory page for Biman Bangladesh Airlines",
      sourceUrl: 'https://www.heathrow.com/departures/terminal-3/flight-details/BG202',
      verifiedDate: '2026-07-30',
      reviewDueDate: '2026-08-13',
      note: 'Recheck (founder-directed): Heathrow\'s own site now confirms live, current flight-tracking pages for named flight numbers BG201 (Dhaka-London, Terminal 4 arrival) and BG202 (London-Dhaka, Terminal 3 departure) — real, current evidence this exact service operates, going beyond the previous terminal-directory-only finding. Several independent flight-schedule aggregators (not treated as primary sources here, per this project\'s sourcing standard) consistently describe BG202 as making a scheduled stop at Sylhet, structurally matching Biman\'s confirmed current Manchester-Sylhet-Dhaka through-flight pattern on the same UK network — but this session could not get a Heathrow or Biman primary source to directly confirm or rule out a Sylhet stop on this specific flight (Heathrow\'s flight-status detail did not render fully to this session\'s fetch tooling; Biman\'s own site returned a 403 error on every attempt). Kept unverified: the safest accurate status given real evidence of current operation but no confirmed stop pattern either way — do not publish a "nonstop" claim, and do not publish a specific duration or frequency, until a genuine Biman or Heathrow route-specific primary source resolves this.',
    },
    intro:
      'Biman Bangladesh Airlines currently operates a real, live London Heathrow to Dhaka service — Heathrow\'s own flight-tracking system confirms named flights BG201 and BG202 (arriving Terminal 4, departing Terminal 3 respectively) — but no primary source directly confirms whether this service is nonstop or, like Biman\'s Manchester service, makes a scheduled stop at Sylhet. Several independent flight-schedule sources describe a Sylhet stop on this same flight, consistent with Biman\'s confirmed Manchester pattern, but this has not been confirmed against Biman\'s own site or a Heathrow route-specific source. Treat any "direct London to Dhaka" or "nonstop" claim seen elsewhere as unconfirmed until checked directly with the airline.',
    bookingWindowNote:
  ...
  },
  {
    ...
    airportSlug: 'manchester',
    destinationSlug: 'dhaka',
    flightTime: 'Around 10h with a one-stop, same-aircraft stop at Sylhet — never nonstop on any current or historical evidence, see note',
    frequency: 'Two weekly flights (Tuesdays and Saturdays) since the July 2026 resumption — attributed to current Bangladeshi news reporting, not yet reconfirmed against Biman\'s own site, see note',
    airlineSlugs: ['biman-bangladesh'],
    isDirect: false,
    verification: {
      status: 'verified',
      sourceName: "Manchester Airport's own media centre (launch/relaunch history) plus multiple independent current Bangladeshi news outlets covering the July 2026 resumption: Bangladesh Sangbad Sangstha (BSS, the state news agency), Dhaka Tribune, The Business Standard, and aviation trade publication AeroRoutes",
      ...
      verifiedDate: '2026-07-30',
      reviewDueDate: '2026-08-30',
      note: 'One-stop via Sylhet, never an ordinary multi-airline connection: this is a single Biman flight, same aircraft throughout, with a scheduled stop at Sylhet — not a change of airline, aircraft or terminal. Multiple independent current (July 2026) Bangladeshi sources consistently and specifically describe both directions of this exact pairing: outbound "Dhaka to Manchester via Sylhet", and the return leg departing Manchester, reaching Sylhet the next morning, then Dhaka — with the same flight number (BG-208) reported across the Sylhet and onward legs, supporting same-aircraft operation. These sources also consistently describe the service as resuming after a roughly four-month suspension, with the first relaunch flight reported landing 5 July 2026 (the wider resumption window is separately described as "from 1 July 2026" — treated as the announced restart date rather than a contradiction) and an initial frequency of two flights weekly, Tuesdays and Saturdays. None of this is Biman\'s own official website directly — biman-airlines.com returned a 403 error to this session\'s tooling on every attempt across two research rounds — so the schedule is attributed to current third-party reporting, with BSS (Bangladesh\'s state news agency) treated as the closest available quasi-official source. Given this route\'s documented history of repeated withdrawal and relaunch since January 2020, this record should be re-checked on its review date regardless of how settled the current evidence looks.',
    },
    intro:
      "Manchester to Dhaka is not an ordinary connection: it is one Biman Bangladesh Airlines flight, on the same aircraft throughout, making a scheduled one-stop at Sylhet — never a nonstop service, and never a separate connecting airline or terminal change. Multiple independent current Bangladeshi news sources (including the state news agency BSS) describe this exact one-stop-via-Sylhet service resuming in July 2026 after roughly four months' suspension, running twice weekly on Tuesdays and Saturdays. That schedule is not yet confirmed against Biman's own website, which has been unreachable to this session's tooling, and this service has a documented history of being withdrawn and relaunched more than once — confirm the current routing and schedule directly with Biman before booking.",
    bookingWindowNote:
  ...
  },
  {
    ...
    verification: {
      status: 'unverified',
      sourceName: "Manchester Airport's own current Sylhet destination page (manchesterairport.co.uk/destinations-and-guides/sylhet/), directly fetched, set against multiple independent current Bangladeshi news sources describing a July 2026 Manchester-Sylhet-Dhaka resumption",
      sourceUrl: 'https://www.manchesterairport.co.uk/destinations-and-guides/sylhet/',
      verifiedDate: '2026-07-30',
      reviewDueDate: '2026-08-13',
      note: 'A genuine, current, directly-fetched contradiction, not a stale or secondary one: Manchester Airport\'s own Sylhet destination page states plainly, "We\'re not flying to this location at the moment, but check back soon for updates!" — while multiple independent current Bangladeshi news outlets (BSS, Dhaka Tribune, The Business Standard, AeroRoutes) describe Biman\'s Manchester-Dhaka service, which has a scheduled Sylhet stop on both legs, as having resumed in July 2026 (see manchester-dhaka\'s own verification note). Manchester Airport\'s own page appears not to separately list a stop that is only a technical/through stop on a Dhaka-bound flight rather than a standalone destination it markets — but that is an inference, not something either source states. Kept Verification Pending rather than resolved either way until a source addresses this specific gap. Given the live contradiction, this record carries a shorter review window than the routes.ts default.',
    },
    intro:
      'Manchester to Sylhet sits on a genuine, currently unresolved contradiction between two directly-checked sources: Manchester Airport\'s own Sylhet page states it is "not flying to this location at the moment", while independent current Bangladeshi news reporting describes Biman\'s resumed Manchester-Dhaka service making a scheduled stop at Sylhet on every rotation. It is possible Manchester Airport simply does not list a through-stop as a standalone destination, but that has not been confirmed. Given the service\'s documented history of suspension and relaunch, check the current routing and stop pattern directly with Biman before booking or assuming Sylhet is reachable from Manchester on its own ticket.',
    bookingWindowNote:
      'This route\'s service history has been too unstable for a reliable booking-window pattern. If currently operating, confirm the live schedule and exact stop pattern directly with Biman Bangladesh Airlines before booking, especially around Eid, when demand and disruption risk both rise.',
    peakPeriodIds: ['eid-al-fitr', 'eid-al-adha', 'uk-summer-holidays'],
  },
  {
    ...
    verification: {
      status: 'unverified',
      sourceName: "Heathrow's own live flight-tracking pages for flight BG202 (London to Dhaka, departing Terminal 3), plus multiple independent flight-schedule aggregators describing BG202 as routing via Sylhet",
      sourceUrl: 'https://www.heathrow.com/departures/terminal-3/flight-details/BG202',
      verifiedDate: '2026-07-30',
      reviewDueDate: '2026-08-13',
      note: 'Added this session (founder-directed correction: the earlier "zero evidence" rejection was inaccurate — real signal exists, even if not yet primary-source-confirmed). Heathrow\'s own site confirms a live, current flight-tracking page for BG202 (London to Dhaka, departing Terminal 3) and BG201 (Dhaka to London, arriving Terminal 4) — real evidence of a currently operating London-Dhaka Biman service. Several independent flight-schedule aggregators (flightmapper.net, Skyscanner, FlightsFrom.com and others — not treated as primary sources here, per this project\'s sourcing standard) consistently describe BG202 as making a scheduled stop at Sylhet, and some describe London-Sylhet as a separately bookable itinerary on that same flight, structurally matching Biman\'s confirmed current Manchester-Sylhet-Dhaka through-flight pattern. This session could not get a Heathrow or Biman primary source to confirm a Sylhet stop, a Sylhet-specific flight number, or a Sylhet schedule directly (Heathrow\'s flight-status detail did not render fully to this session\'s fetch tooling; Biman\'s own site returned a 403 error on every attempt). Held as Verification Pending rather than added as confirmed or excluded outright: real signal, not yet primary-source-proof. Do not publish a specific duration, frequency or stop-pattern claim until a genuine Biman or Heathrow route-specific source resolves this.',
    },
    intro:
      "Biman Bangladesh Airlines currently operates a real, live London Heathrow to Dhaka service — Heathrow's own flight-tracking system confirms named flight BG202, departing Terminal 3 — and independent flight-schedule sources consistently describe that same flight as making a scheduled stop at Sylhet, some describing London-Sylhet as separately bookable on it, mirroring Biman's confirmed Manchester-Sylhet-Dhaka pattern. JetStash has not been able to confirm this Sylhet stop, or any Heathrow-Sylhet-specific schedule, against a genuine Biman or Heathrow primary source, so no duration, frequency or booking guidance is published here. Check directly with Biman Bangladesh Airlines for the current routing before booking.",
    bookingWindowNote:
