...
export const routes: Route[] = [
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-10-04',
      note: 'Birmingham Airport lists direct Jet2, TUI and easyJet service and publishes an approximate 4h05 flight time. Individual scheduled flights can differ, so check the exact airline, date and timing before booking. Rolling Reverification Batch 5 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly. The page also states its own "Seasons: High = April-October; Low = November-May" -- a genuine, dated seasonal-service signal from the airport\'s own page, matching the pattern already applied to Birmingham\'s Faro/Rome/Agadir/Antalya pages in Batches 3-4. First formal cadence classification for this route: RECENT / CHANGING (30-day window), not STABLE -- three confirmed operators show route maturity, but the airport\'s own seasonal framing means the evidence does not affirmatively rule out seasonal instability.',
    },
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-10-04',
      note: 'Birmingham Airport lists direct Jet2 and TUI service and publishes an approximate 4h15 flight time. Jet2 currently markets Birmingham–Bodrum for its summer programme. Exact operating days and season boundaries across airlines require checking before booking. Rolling Reverification Batch 5 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly. The page states its own "Seasons: High = April-October; Low = November-May" -- directly corroborating the existing seasonal framing rather than contradicting it. First formal cadence classification: RECENT / CHANGING (30-day window) -- the airport\'s own explicit seasonal split is affirmative evidence of instability, not merely an absent year-round statement.',
    },
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-12-04',
      note: 'Glasgow Airport lists direct TUI, Jet2 and easyJet Dalaman services across published date ranges and gives an approximate 4h42 flight duration. Exact dates, frequency and individual timings vary by schedule. Rolling Reverification Batch 5 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- same three operators, same 4h42m figure. Unlike the Antalya page above, this page carries no explicit "year round" sentence, but its own live flight-schedule table shows multiple individual services spanning close to a full year across all three operators (e.g. TUI TOM526, 31/08/26-30/08/27; Jet2 LS195, 04/09/26-03/09/27; easyJet EZY3167, 02/09/26-04/08/27) -- real, dated schedule depth, not a narrow summer window. Reclassified STABLE (90-day window) on this multi-operator, near-year-round schedule evidence.',
    },
  ...
  },
  {
    ...
    verification: { status: 'verified', sourceName: "Birmingham Airport's official Athens destination page", sourceUrl: 'https://airport.birminghamairport.co.uk/destinations/where-we-fly/athens/?searchresult=true', verifiedDate: '2026-09-04', reviewDueDate: '2026-10-04', note: 'Birmingham Airport lists direct Athens service, names Jet2 and gives an approximate 3h50m duration. Its seasonality and operating days vary by schedule. Rolling Reverification Batch 5 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- Jet2 remains the sole named operator, 3h50m duration unchanged. The page states its own "Seasons: High = June-September; Low = November-March", an explicit summer-peak framing. First formal cadence classification: RECENT / CHANGING (30-day window) -- a single operator plus an explicit seasonal split gives no basis for STABLE.' },
