...
export const routes: Route[] = [
  ...
  },
  {
    ...
    peakPeriods: ['Eid al-Fitr', 'Eid al-Adha', 'Wedding season (Nov–Feb)', 'UK summer holidays'],
  },
  {
  ...
  },
  {
    ...
    peakPeriods: ['Eid al-Fitr', 'Eid al-Adha', 'UK summer holidays'],
  },
  {
    ...
    airlines: ['Air India', 'Etihad Airways'],
    isDirect: false,
    intro:
    ...
    peakPeriods: ['Baisakhi (April)', 'Diwali', 'UK summer holidays'],
  },
  {
  ...
  },
  {
    ...
    airlines: ['Turkish Airlines', 'Qatar Airways', 'Saudia'],
    isDirect: false,
    intro:
  ...
  },
  {
    ...
    peakPeriods: ['Navratri', 'Diwali', 'UK summer holidays'],
  },
  {
  ...
  },
  {
    ...
    airlines: ['Qatar Airways', 'IndiGo', 'British Airways', 'Air India'],
    isDirect: false,
    intro:
  ...
  },
  {
    ...
    frequency: 'Multiple daily 1-stop options, no direct service',
    airlines: ['Qatar Airways', 'Etihad Airways', 'Emirates'],
    isDirect: false,
    intro:
  ...
  },
  {
    ...
    airlines: ['Turkish Airlines', 'Saudia', 'EgyptAir', 'Royal Jordanian'],
    isDirect: false,
    intro:
