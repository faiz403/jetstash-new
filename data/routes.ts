...
export const routes: Route[] = [
  ...
  },
  {
    ...
    intro:
      'Current 2026 route reporting describes PIA\'s direct Lahore services as ex-Manchester and ex-Heathrow only — we can\'t currently confirm a direct Birmingham–Lahore PIA service. Manchester\'s PIA Lahore service is confirmed direct and may be a realistic alternative if travelling there is practical; otherwise compare a Gulf-hub connection. Check PIA\'s own booking system directly before booking.',
    bookingWindowNote:
