...
export const routes: Route[] = [
  ...
  },
  {
    ...
    verification: {
      ...
      note: 'Route Verification Refresh Batch 1 (18 August 2026): Air India\'s own current booking route and its own newsroom press release both still identify London Gatwick (LGW) to Amritsar (ATQ) as a nonstop route (3x weekly, Boeing 787-8); no cancellation or suspension found. However, Air India\'s Gatwick India network is not currently stable — its sibling Gatwick-Ahmedabad service was found this same session to be temporarily inoperative, replaced by a Heathrow service, as part of Air India\'s wider "Safety Pause" operational adjustment (1 Aug-30 Sept 2026; see london-gatwick-ahmedabad\'s own record, left unrefreshed this batch). No evidence was found that Amritsar is specifically affected, but given the adjacent disruption on the same Gatwick-India network, this is classified RECENT / CHANGING rather than STABLE as a precaution — 30-day review window per the locked verification cadence policy, not the 90-day STABLE window. Due-date reverification (17 September 2026): the 18 August check\'s own cited booking-route URL (airindia.com/en-in/book-flights/london-to-amritsar-flights), re-opened directly today, now shows the same self-contradicting template already documented on this route\'s sibling disputed pairs (london-gatwick-ahmedabad, birmingham-ahmedabad) -- a structured "0 direct flights connect London and Amritsar" field alongside marketing copy that still says "fly directly", and no Gatwick-vs-Heathrow airport distinction anywhere on either directional page. That page alone is no longer treated as sufficient current evidence. The 27 March 2023 newsroom press release (airindia.com/in/en/newsroom/press-release/air-india-launches-non-stop-flight-from-amritsar-to-london-gatwi.html), while still live and uncontradicted, is HISTORICAL launch-announcement evidence, not current 2026 operational proof, and is not being relied on alone to renew a September 2026 verified claim. Genuine CURRENT primary evidence was found instead: Air India\'s own 16 February 2026 newsroom press release on its Northern Summer Schedule 2026 product deployment (airindia.com/in/en/newsroom/press-release/Air-India-upgrades-product-and-customer-experience-on-more-international-routes-this-summer.html) states, effective 1 August 2026 (a date already passed), "Air India\'s flights to Birmingham from Amritsar and Delhi, and to London (Gatwick) from Ahmedabad and Amritsar will be operated with Air India\'s legacy B777-300ER, replacing the currently deployed legacy B787-8". This is current, dated, primary confirmation that Air India currently operates a London Gatwick-Amritsar service (the route\'s continued existence, and Air India as the operator, are CURRENTLY SUPPORTED) -- but it also directly CONTRADICTS this record\'s own prior "Boeing 787-8" note, which is corrected here: the aircraft is B777-300ER as of 1 August 2026, not B787-8. No current 2026 primary source (only the 2023 press release, historical-only) confirms the "3x weekly" frequency or "Mon/Thu/Sat" operating days originally noted here, so that specificity is not restated as current fact -- consistent with the route\'s own public frequency field, deliberately hedged to "exact operating days vary" since the 28 July 2026 truth correction (see the resolved lgw-atq-reduced-frequency route-warning, data/route-warnings.ts), which already avoids asserting a specific frequency. Gatwick Airport\'s own official site was checked for a route-specific destination page this session; none could be located (only OTA/metasearch results were found, not treated as primary here). Net effect: retained verified, direct-service-exists, Air India-operated -- the two claims current primary evidence actually supports -- with the stale aircraft claim corrected and the frequency/operating-days claim left unasserted rather than administratively renewed. Remains RECENT / CHANGING given the newly-found evidence-quality concern on the booking page template; 30-day review window per the locked verification cadence policy.',
    },
    intro:
