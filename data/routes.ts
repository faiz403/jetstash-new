...
export const routes: Route[] = [
  ...
  },
  {
    ...
    verification: { status: 'verified', sourceName: "Birmingham Airport's official Barcelona destination page", sourceUrl: 'https://airport.birminghamairport.co.uk/destinations/where-we-fly/barcelona/', verifiedDate: '2026-09-20', reviewDueDate: '2026-12-19', note: 'Astra2-B1 route-truth maintenance (20 September 2026): reconfirmed via Birmingham Airport\'s own dedicated Barcelona destination page, reopened live today, which states "Airlines that fly direct: easyJet, Jet2.com, Ryanair and Vueling" and "Approximate flight time: 2 hours 05 minutes" — evidence recorded here for the record, but not surfaced in public copy: this batch\'s purpose is reconfirming the existing direct-service claim, not enriching the page, and a partial airlineSlugs list (only easyJet/Jet2 are catalogued; Ryanair/Vueling are not) would render as though those were the only operators via the route page\'s unqualified "Airlines" stat. The page\'s own "Seasons: High = March-August, Low = November-March" field is not treated as a seasonal-service signal — the identical field already appears on multiple confirmed year-round routes elsewhere in this file (see birmingham-faro\'s own note), so it is established generic tourism best-time-to-visit content, not flight-schedule evidence. With four confirmed current operators and no seasonal/volatility signal, reclassified STABLE (90-day window) per the locked verification cadence policy.' },
  ...
  },
  {
    ...
    verification: { status: 'verified', sourceName: "Bristol Airport's official Barcelona destination page", sourceUrl: 'https://www.bristolairport.co.uk/where-can-i-fly/destinations/europe/spain/barcelona', verifiedDate: '2026-09-20', reviewDueDate: '2026-12-19', note: 'Astra2-B1 route-truth maintenance (20 September 2026): reconfirmed via Bristol Airport\'s own dedicated Barcelona destination page, reopened live today, which states plainly "We fly: All year round" and "Flight days: Mon, Tue, Wed, Thur, Fri, Sat & Sun" (i.e. daily), with confirmed live booking links naming easyJet (flights and holidays) and Ryanair as operators. Evidence recorded here for the record, but not surfaced in public copy: this batch\'s purpose is reconfirming the existing direct-service claim, not enriching the page, and a partial airlineSlugs list (only easyJet is catalogued; Ryanair is not) would render as though easyJet were the sole operator via the route page\'s unqualified "Airlines" stat. Reclassified STABLE (90-day window) on the airport\'s own explicit "all year round" and daily-frequency statement, per the locked verification cadence policy.' },
