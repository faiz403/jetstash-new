...
export const routes: Route[] = [
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-10-04',
      note: 'Glasgow Airport lists direct TUI, Jet2 and easyJet Dalaman services across published date ranges and gives an approximate 4h42 flight duration. Exact dates, frequency and individual timings vary by schedule. Rolling Reverification Batch 5 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- same three operators, same 4h42m figure. Corrected on PR review (evidence-discipline check) from an initial STABLE call: the page carries no explicit "year round" sentence (unlike the Antalya page), and its own live flight-schedule table is genuinely mixed, not uniformly near-year-round as first read -- some entries do span close to a full year (e.g. TUI TOM526, 31/08/26-30/08/27), but others on the very same table are plainly short 6-7 week windows (e.g. Jet2 LS151, 31/08/26-19/10/26; TUI TOM678, 06/09/26-18/10/26) that read as summer-only add-on capacity. A "Winter Sun Destinations" tag also appears on this page, but it is a generic content-taxonomy category shared with unrelated pages, not a flight-schedule claim, and is not relied on either way. Given the genuinely mixed schedule evidence and no independent route-level statement to resolve it, this does not yet affirmatively rule out seasonal instability. Reclassified RECENT / CHANGING (30-day window).',
    },
