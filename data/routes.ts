...
export const routes: Route[] = [
  ...
  },
  {
    ...
    frequency: 'SunExpress: 15 weekly direct overnight flights in its current summer 2026 programme; exact dates may vary',
    ...
    verification: {
      ...
      note: 'Route Verification Refresh, 12 September due-soon batch (7 September 2026): reconfirmed via the same primary source, still live. A genuine evidence upgrade — the release now states 15 weekly Manchester–Dalaman flights (up from the prior note\'s unquantified "seven days per week"), with exact overnight timings (depart Manchester 00:45, arrive Dalaman 07:00; return depart Dalaman 21:05, arrive Manchester 23:45) as part of its current, ongoing summer 2026 programme. Manchester Airport\'s own destination page reconfirmed the same 4h30m flight time, unchanged. Classified RECENT/CHANGING (30-day window): this is a seasonal Turkey service, the category the cadence policy places seasonal routes in regardless of how well-established the season itself is.',
    },
    intro:
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-07',
      reviewDueDate: '2026-10-07',
      note: 'Route Verification Refresh, 12 September due-soon batch (7 September 2026): reconfirmed via the same primary source, still live and unchanged — SunExpress still states twice-weekly direct Manchester–Bodrum service for summer 2026. Manchester Airport\'s own destination page was independently re-read and still states plainly that flights to Bodrum are offered in summer only. Jet2\'s own site presented a bot-challenge page this session and was not independently re-checked; its route-example duration is retained unchanged from the prior evidence. Classified RECENT/CHANGING (30-day window) — an explicitly seasonal ("summer only") service, exactly the category the cadence policy assigns regardless of how consistently it has run in prior seasons.',
    },
    intro:
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-07',
      reviewDueDate: '2026-10-07',
      note: 'Route Verification Refresh, 12 September due-soon batch (7 September 2026): Manchester Airport\'s own destination page was independently re-read and still lists a 4h45m flight time, unchanged. SunExpress\'s own current Crystal Palace F.C. partnership press release, checked live this session, independently reconfirms "up to 24 weekly flights to Antalya" from Manchester as part of its ongoing programme. The flight-plan PDF itself downloads rather than renders in-browser and was not independently re-read this session; Jet2 and Corendon\'s own sites presented a bot-challenge page and were not independently re-checked — their airlineVerifications entries below retain their prior verifiedDate/reviewDueDate rather than a false fresh check. Classified RECENT/CHANGING (30-day window) — a seasonal Turkey service.',
    },
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-07',
      reviewDueDate: '2026-10-07',
      note: 'Route Verification Refresh, 12 September due-soon batch (7 September 2026): Manchester Airport\'s own destination page was independently re-read and still lists a 4h20m planning duration, unchanged. SunExpress\'s own current Crystal Palace F.C. partnership press release, checked live this session, independently reconfirms Izmir remains a current Manchester Turkey destination, corroborating the 19 weekly flights already recorded here (that specific figure comes from the flight-plan PDF, which downloads rather than renders in-browser and was not independently re-read this session). Classified RECENT/CHANGING (30-day window) — a seasonal Turkey service.',
    },
    intro:
  ...
  },
  {
    ...
    verification: {
      ...
      note: 'Birmingham Airport lists direct Corendon, easyJet, Jet2, TUI and SunExpress service and publishes an approximate 4h20 flight time. Exact dates, airline availability, frequency and duration vary by schedule; no year-round claim is made. Rolling Reverification Batch 4 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- 4h20m, all five operators still named. The page also states its own "Seasons: High = April-June; Low = November-March" -- a genuine, dated seasonal-service signal from the airport\'s own page, matching the same pattern found on Birmingham\'s Faro/Rome/Agadir pages in Batch 3. First formal cadence classification for this route: RECENT / CHANGING (30-day window), not STABLE -- multiple confirmed operators show route maturity, but the airport\'s own seasonal framing means the evidence does not affirmatively rule out seasonal instability.',
    },
  ...
  },
  {
    ...
    verification: {
      ...
      note: 'Birmingham Airport lists direct Jet2, TUI and easyJet service and publishes an approximate 4h05 flight time. Individual scheduled flights can differ, so check the exact airline, date and timing before booking. Rolling Reverification Batch 5 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly. Corrected on PR review (evidence-discipline check): this route\'s page also states "Seasons: High = April-October; Low = November-May", initially treated as a genuine seasonal-service signal -- but the identical page, in the identical position, appears on Birmingham Airport\'s Istanbul destination page too ("Seasons: High = April-June; Low = October-March"), a route independently confirmed STABLE via Turkish Airlines\' own explicit "no changes... throughout the year" statement (see that route\'s verification note). Since a genuinely year-round route still carries this field, it is a generic tourism/best-time-to-visit content widget applied uniformly across Birmingham\'s destination pages, not flight-schedule evidence, and is withdrawn as a cadence signal here (and should be re-examined wherever else it was relied on -- flagged separately, not corrected in this PR). On the evidence that remains -- three confirmed current operators, exact duration match, no genuine volatility signal -- reclassified STABLE (90-day window).',
    },
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-10-04',
      note: 'Birmingham Airport lists direct Jet2 and TUI service and publishes an approximate 4h15 flight time. Jet2 currently markets Birmingham–Bodrum for its summer programme -- a genuine, airline-sourced service-seasonality signal, independent of Birmingham Airport\'s own page. Exact operating days and season boundaries across airlines require checking before booking. Rolling Reverification Batch 5 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- same two operators, same 4h15m figure. Corrected on PR review (evidence-discipline check): the page also states "Seasons: High = April-October; Low = November-May", initially cited as corroborating evidence -- but this same field appears identically on Birmingham Airport\'s Istanbul page, a route confirmed STABLE via Turkish Airlines\' own explicit year-round statement, proving it is generic tourism content, not flight-schedule evidence. It is withdrawn as a cadence signal here. First formal cadence classification: RECENT / CHANGING (30-day window) -- sustained on Jet2\'s own "summer programme" marketing alone, a real service-seasonality signal the generic field is not.',
    },
  ...
  },
  {
    ...
    frequency: 'Leeds Bradford Airport names Jet2, TUI and SunExpress as operators; exact dates and frequency vary by airline and schedule',
    airlineSlugs: ['jet2', 'tui', 'sunexpress'],
    isDirect: true,
    verification: {
      status: 'verified',
      sourceName: "Leeds Bradford Airport's own live departures board, corroborated by its current Antalya destination page",
      sourceUrl: 'https://www.leedsbradfordairport.co.uk/flights/departures',
      verifiedDate: '2026-09-08',
      reviewDueDate: '2026-10-08',
      note: 'Route Verification 12 September final five (8 September 2026): the genuinely unresolved evidence-depth question this record has carried since Rolling Reverification Batch 6 (4 September 2026) is resolved -- Leeds Bradford Airport\'s own live departures board, checked today, shows flight LS213 (Jet2) departing 16:40 today to Antalya, with a live check-in status. This is real, current, operational flight-board evidence (the cadence policy\'s "airport official current flight board" source category), not merely a static marketing page, and confirms a genuinely current nonstop service is actually operating today. Combined with the destination page\'s own named operators (Jet2, TUI, SunExpress, from Batch 6, still current), this is now sufficient to classify RECENT/CHANGING (30-day window) -- a seasonal Turkey route with a first-ever genuine continuity confirmation, matching the treatment already used for the equivalent Manchester/Gatwick Turkey routes.',
    },
    ...
    intro:
      'Leeds Bradford Airport names Jet2, TUI and SunExpress as operators for its direct Antalya service. The airport does not publish a fixed duration or frequency, so check the exact operating airline, date and itinerary before booking.',
    bookingWindowNote:
  ...
  },
  {
    ...
    destinationSlug: 'dalaman',
    flightTime: 'Published duration not listed by Leeds Bradford Airport; check the exact flight for your dates',
    frequency: "Leeds Bradford Airport names Jet2 Holidays and TUI as operators; exact dates and frequency vary by airline and schedule",
    airlineSlugs: ['jet2', 'tui'],
    isDirect: true,
    verification: {
      status: 'verified',
      sourceName: "Leeds Bradford Airport's own live departures board, corroborated by its current Dalaman destination page",
      sourceUrl: 'https://www.leedsbradfordairport.co.uk/flights/departures',
      verifiedDate: '2026-09-08',
      reviewDueDate: '2026-10-08',
      note: 'Route Verification 12 September final five (8 September 2026): resolves the evidence-depth question deliberately left open on 7 September -- Leeds Bradford Airport\'s own live departures board, checked today, shows flight LS413 (Jet2) departing 16:30 today to Dalaman, with a live check-in status. This is real, current, operational flight-board evidence, not merely a static marketing page, and confirms a genuinely current nonstop service is actually operating today. Combined with the destination page\'s own named operators (Jet2 Holidays, TUI, from the 7 September check, still current), this is now sufficient to classify RECENT/CHANGING (30-day window) -- a seasonal Turkey route with a first-ever genuine continuity confirmation, matching the treatment already used for the equivalent Manchester/Gatwick Turkey routes.',
    },
    airlineVerifications: ['jet2', 'tui'].map((airlineSlug) => ({
      airlineSlug,
      status: 'verified' as const,
      sourceName: "Leeds Bradford Airport's current Dalaman destination page",
      sourceUrl: 'https://www.leedsbradfordairport.co.uk/destinations/turkey/dalaman',
      verifiedDate: '2026-09-07',
      reviewDueDate: '2026-09-12',
      effectivePeriod: 'Current at access',
      supportedClaim: 'Named as flying direct from Leeds Bradford to Dalaman, on the airport\'s own destination page.',
      remainingUncertainty: 'Exact dates, frequency and duration are not stated on this page.',
    })),
    intro:
      'Leeds Bradford Airport names Jet2 Holidays and TUI as operators for its direct Dalaman service. The airport does not publish a fixed duration or frequency, so check the exact operating airline, date and itinerary before booking.',
    bookingWindowNote:
  ...
  },
  {
    ...
    destinationSlug: 'bodrum',
    flightTime: 'Published duration not listed by Leeds Bradford Airport; check the exact flight for your dates',
    frequency: 'Leeds Bradford Airport\'s own live departures board names Jet2 as a current operator; exact dates and frequency vary by schedule',
    airlineSlugs: ['jet2'],
    isDirect: true,
    verification: {
      status: 'verified',
      sourceName: "Leeds Bradford Airport's own live departures board",
      sourceUrl: 'https://www.leedsbradfordairport.co.uk/flights/departures',
      verifiedDate: '2026-09-08',
      reviewDueDate: '2026-10-08',
      note: 'Route Verification 12 September final five (8 September 2026): resolves the "too thin to classify" state this record has carried since Rolling Reverification Batch 6 (4 September 2026) -- unlike the destination page (which names no operator for Bodrum, still true today), Leeds Bradford Airport\'s own live departures board, checked today, shows flight LS215 (Jet2) with a live "on schedule" status, direct to Bodrum. This is real, current, operational flight-board evidence, not merely a static marketing page, and confirms a genuinely current nonstop service is actually operating today, with Jet2 named as the operator for the first time on real evidence (added to airlineSlugs). Classified RECENT/CHANGING (30-day window) -- a seasonal Turkey route with a first-ever genuine continuity confirmation, matching the treatment already used for the equivalent Manchester/Gatwick Turkey routes.',
    },
    airlineVerifications: [{
      airlineSlug: 'jet2',
      status: 'verified' as const,
      ...
      verifiedDate: '2026-09-08',
      reviewDueDate: '2026-10-08',
      effectivePeriod: 'Live flight LS215, 8 September 2026',
      supportedClaim: 'Operates a real, current, scheduled direct flight from Leeds Bradford to Bodrum, confirmed on the airport\'s own live departures board.',
      remainingUncertainty: 'Exact frequency and duration are not stated by this source.',
    }],
    intro:
      'Leeds Bradford Airport\'s own live departures board confirms a current direct Jet2 service to Bodrum. The airport does not publish a fixed duration or frequency, so check the exact flight and season before booking.',
    bookingWindowNote:
      'This guide is route context, not a booking prediction. Check the exact seasonal schedule, duration, fare conditions and baggage terms before booking.',
    peakPeriodIds: [],
  },
  {
    ...
    airportSlug: 'glasgow',
    destinationSlug: 'antalya',
    flightTime: 'Published duration not stated by Glasgow Airport; check the exact flight for your dates',
    frequency: "Glasgow Airport's own page states \"fly direct year round\" with Corendon Airlines, easyJet, Jet2.com and TUI; exact dates and frequency vary by airline and schedule",
    airlineSlugs: ['jet2', 'easyjet', 'corendon', 'tui'],
    isDirect: true,
    verification: {
      status: 'verified',
      sourceName: "Glasgow Airport's current Antalya destination page",
      sourceUrl: 'https://www.glasgowairport.com/destinations/antalya/',
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-12-03',
      note: 'Rolling Reverification Batch 5 (4 September 2026): a genuine evidence upgrade -- Glasgow Airport\'s own page states plainly "Fly direct year round with Corendon Airlines, easyJet, Jet2.com and TUI", naming two operators (Corendon, TUI) not previously recorded for this route. Both are in the airline catalogue (data/airlines.ts), so both are added to airlineSlugs. The page\'s own live flight-schedule table corroborates this with real, dated flights: several individual services span close to a full year (e.g. easyJet EZY3181, 02/09/26-23/06/27; Jet2 LS197, 06/09/26-18/07/27), not a narrow summer-only window. Reclassified STABLE (90-day window) on the combination of an explicit airline-page "year round" statement and real schedule dates spanning most of a year across multiple operators -- affirmatively ruling out seasonal instability, not merely an accurate operator count.',
    },
    airlineVerifications: ['jet2', 'easyjet', 'corendon', 'tui'].map((airlineSlug) => ({
      airlineSlug,
      status: 'verified' as const,
      sourceName: "Glasgow Airport's current Antalya destination page",
      sourceUrl: 'https://www.glasgowairport.com/destinations/antalya/',
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-12-03',
      effectivePeriod: 'Current at access; published flight-schedule dates run through mid-to-late 2027',
      supportedClaim: 'Lists direct service from Glasgow to Antalya, named on the page\'s own "fly direct year round" statement.',
      remainingUncertainty: 'Exact operating dates, frequency and duration vary by individual flight.',
    })),
    intro:
      'Glasgow Airport\'s own page says it flies direct to Antalya year round with Corendon Airlines, easyJet, Jet2.com and TUI. Its published flight schedule shows individual services running across most of the year. Exact dates, frequency and flight duration vary by airline and schedule, so check your itinerary before booking.',
    bookingWindowNote:
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-12-03',
      note: 'Glasgow Airport lists direct TUI, Jet2 and easyJet Dalaman services across published date ranges and gives an approximate 4h42 flight duration. Exact dates, frequency and individual timings vary by schedule. Rolling Reverification Batch 5 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- same three operators, same 4h42m figure. Corrected twice on PR review: an initial STABLE call was first downgraded to RECENT/CHANGING on the reasoning that the page\'s schedule table is "genuinely mixed" (some entries near-year-long, others short summer windows) -- that reasoning conflated frequency/operator-level seasonal variation with route-level service instability. TUI\'s own TOM526 (31/08/26-30/08/27) is essentially a full year of continuous direct route-level operation on its own, with no route suspension, service-ended event, relaunch, or proven route-level seasonal gap. That the same route also carries shorter seasonal Jet2/TUI flight numbers on top of TOM526\'s continuous service is evidence of supplementary frequency variation, not that the route itself is seasonal -- the same distinction already locked for this project\'s route-level-vs-per-airline cadence standard. Reclassified STABLE (90-day window). This does not claim every operator or frequency on this route runs year-round -- only that continuous route-level service is established.',
    },
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-10-04',
      note: 'Glasgow Airport lists seasonal direct Jet2 Bodrum services for published summer date ranges and gives an approximate 4h33 flight duration. Exact operating dates and frequency vary by schedule. Rolling Reverification Batch 6 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- Jet2 remains the sole named operator, 4h33m unchanged. Unlike the sibling Antalya and Dalaman pages from the same airport (which show flights spanning close to a full year across multiple operators), this page\'s own live flight-schedule table shows only short, clustered windows (e.g. 06/09/26-27/09/26, 03/09/26-22/10/26) -- genuine, dated schedule evidence of a real seasonal pattern, not a generic tourism-content field. First formal cadence classification: RECENT / CHANGING (30-day window).',
    },
    airlineVerifications: [{
      airlineSlug: 'jet2',
      status: 'verified',
  ...
  },
  {
    ...
    destinationSlug: 'dalaman',
    flightTime: 'Published duration not listed on Bristol Airport\'s route page; check the exact flight for your dates',
    frequency: 'Bristol Airport\'s own page states it flies daily from March to November (summer only), with easyJet, TUI and Jet2.com',
    airlineSlugs: ['easyjet', 'tui', 'jet2'],
    isDirect: true,
    verification: {
      status: 'verified',
      ...
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-10-04',
      note: 'Rolling Reverification Batch 6 (4 September 2026): a genuine evidence upgrade -- Bristol Airport\'s own page states plainly "We fly: Summer only" and "Fly daily, Mar - Nov", and its airlines section names easyJet, TUI and Jet2.com. All three are in the airline catalogue (data/airlines.ts) and are added to airlineSlugs. Unlike bristol-faro/bristol-rome/bristol-antalya (all "All year round"), this is the airport\'s own explicit, real, route-specific service-seasonality statement -- not a generic tourism High/Low field. Reclassified RECENT / CHANGING (30-day window) on this genuine signal.',
    },
    airlineVerifications: ['easyjet', 'tui', 'jet2'].map((airlineSlug) => ({
      airlineSlug,
      status: 'verified' as const,
      sourceName: "Bristol Airport's current Dalaman destination page",
      sourceUrl: 'https://www.bristolairport.co.uk/where-can-i-fly/destinations/europe/turkey/dalaman/',
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-10-04',
      effectivePeriod: 'March-November, per the airport\'s own summer-only statement',
      supportedClaim: 'Named as flying direct from Bristol to Dalaman, daily, March to November, on the airport\'s own destination page.',
      remainingUncertainty: 'Exact daily frequency split between operators and duration are not stated on this page.',
    })),
    intro:
      "Bristol Airport's own page says it flies direct to Dalaman daily from March to November (summer only), naming easyJet, TUI and Jet2.com among its operators. Exact duration and the airline for your specific date still vary, so check the exact flight before booking.",
    bookingWindowNote:
      'This guide is route context, not a booking prediction. Check the seasonal schedule, duration, fare conditions and baggage terms before booking.',
    peakPeriodIds: [],
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-10-04',
      note: 'Newcastle Airport states that SunExpress flies multiple times a week during summer to Dalaman. The reviewed current page does not publish a fixed frequency or duration, so check the exact date and itinerary before booking. Rolling Reverification Batch 6 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- "Fly multiple times a week during the summer to Antalya and Dalaman with SunExpress" is the airport\'s own current wording, unchanged. This is a genuine, real, airline-specific service-seasonality statement -- not a generic tourism field. First formal cadence classification: RECENT / CHANGING (30-day window).',
    },
    airlineVerifications: [{
      airlineSlug: 'sunexpress',
      status: 'verified',
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-07',
      reviewDueDate: '2026-10-07',
      note: 'Route Verification Refresh, 12 September due-soon batch (7 September 2026): reconfirmed via the same primary source, still live and unchanged — the release still states plainly that fans can fly from London Gatwick to "Antalya, Dalaman and Izmir" in Türkiye. Exact dates, frequency and duration remain unpublished here; Trip.com remains blocked for this airport-specific pair. Classified RECENT/CHANGING (30-day window) — a seasonal Turkey service.',
    },
    airlineVerifications: [{
      airlineSlug: 'sunexpress', status: 'verified', sourceName: "SunExpress official UK network material and Summer 2026 flight plan", sourceUrl: 'https://www.sunexpress.com/en-gb/company/media-center/press-releases/sunexpress-named-official-airline-partner-of-crystal-palace-football-club/', verifiedDate: '2026-09-07', reviewDueDate: '2026-10-07', effectivePeriod: 'Current seasonal UK network / summer 2026 plan', supportedClaim: 'Confirms nonstop SunExpress London Gatwick-Dalaman service.', remainingUncertainty: 'Exact dates, frequency and duration vary by schedule.',
    }],
    intro:
  ...
  },
  {
    ...
    verification: {
      status: 'verified',
      sourceName: 'SunExpress official Summer 2026 flight plan, corroborated by current Crystal Palace F.C. partnership press release',
      sourceUrl: 'https://static.sunexpress.com/media/wn1lmfyn/sxs-flightplan-s26-27nov_0126.pdf',
      verifiedDate: '2026-09-07',
      reviewDueDate: '2026-10-07',
      note: 'Route Verification Refresh, 12 September due-soon batch (7 September 2026): the flight-plan PDF downloads rather than renders in-browser and was not independently re-read this session. SunExpress\'s own current Crystal Palace F.C. partnership press release (https://www.sunexpress.com/en-gb/company/media-center/press-releases/sunexpress-named-official-airline-partner-of-crystal-palace-football-club/), checked live this session, independently reconfirms Izmir remains a current London Gatwick Turkey destination ("from where fans can fly to holiday destinations across Türkiye including Antalya, Dalaman and Izmir"). No fixed frequency or duration is published in either reviewed source, and Trip.com remains blocked for this airport-specific pair. Classified RECENT/CHANGING (30-day window) — a seasonal Turkey service.',
    },
    airlineVerifications: [{
      airlineSlug: 'sunexpress', status: 'verified', sourceName: 'SunExpress official Summer 2026 flight plan, corroborated by current Crystal Palace F.C. partnership press release', sourceUrl: 'https://static.sunexpress.com/media/wn1lmfyn/sxs-flightplan-s26-27nov_0126.pdf', verifiedDate: '2026-09-07', reviewDueDate: '2026-10-07', effectivePeriod: 'April-October 2026 published plan', supportedClaim: 'Lists seasonal direct SunExpress service from London Gatwick to Izmir.', remainingUncertainty: 'Exact frequency, dates and duration vary by schedule.',
    }],
    intro:
  ...
  },
  {
    ...
    verification: {
      status: 'verified',
      sourceName: "Manchester Airport's current Marrakesh destination page, corroborated by Jet2's Manchester–Marrakech booking page",
      sourceUrl: 'https://www.manchesterairport.co.uk/destinations-and-guides/marrakesh/',
      verifiedDate: '2026-09-07',
      reviewDueDate: '2026-12-06',
      note: 'Route Verification Refresh, 12 September due-soon batch (7 September 2026): a genuine evidence upgrade — Manchester Airport\'s own destination page lists Marrakesh under all four of its Holiday Type categories, including both "Summer Sun" AND "Winter Sun" (unlike the Turkey beach routes at this airport, which are explicitly summer-only), affirmatively indicating a year-round service rather than a seasonal one. The same page reconfirms the existing 4-hour flight time, unchanged. Jet2\'s own site presented a bot-challenge page this session and was not independently re-checked; its prior confirmation is retained unchanged. Reclassified STABLE (90-day window) on the strength of this genuine year-round signal, matching the reasoning already used for Glasgow-Antalya (Rolling Reverification Batch 5).',
    },
    intro:
  ...
  },
  {
    ...
    frequency: 'Bristol Airport names easyJet and TUI as operators, up to four flights a week, all year round, on Mon-Sat; exact operating days vary by schedule',
    airlineSlugs: ['easyjet', 'tui'],
    isDirect: true,
    verification: {
      status: 'verified',
      ...
      verifiedDate: '2026-09-07',
      reviewDueDate: '2026-12-06',
      note: 'Route Verification Refresh, 12 September due-soon batch (7 September 2026): a genuine evidence upgrade — the page names easyJet and TUI as current operators (previously recorded with no named operator), explicitly states "We fly: All year round" and "Flight days: Mon, Tue, Wed, Thur, Fri & Sat", and repeats "Fly up to 4 times week". Both operators are in the airline catalogue (data/airlines.ts) and are added to airlineSlugs. Reclassified STABLE (90-day window) on the combination of an explicit "all year round" statement from the airport\'s own page and two named, established operators — affirmatively ruling out seasonal instability, matching the reasoning already used for Glasgow-Antalya (Rolling Reverification Batch 5).',
    },
    airlineVerifications: ['easyjet', 'tui'].map((airlineSlug) => ({
      airlineSlug,
      status: 'verified' as const,
      sourceName: "Bristol Airport's current Marrakech destination page",
      sourceUrl: 'https://www.bristolairport.co.uk/where-can-i-fly/destinations/africa/morocco/marrakech/',
      ...
      reviewDueDate: '2026-12-06',
      effectivePeriod: 'Current at access',
      supportedClaim: 'Named as flying direct from Bristol to Marrakech, all year round, on the airport\'s own destination page.',
      remainingUncertainty: 'Exact dates and duration are not stated on this page.',
    })),
    intro:
      'Bristol Airport names easyJet and TUI as operators for its direct, year-round Marrakech service, with up to four flights a week on Monday to Saturday. Exact operating days, duration and fare conditions remain date-specific, so check your flight before booking.',
    bookingWindowNote:
      'This guide is route context, not a booking prediction. Check the exact service, duration, fare conditions and baggage terms before booking.',
    peakPeriodIds: [],
  },
  {
    ...
    destinationSlug: 'marrakech',
    flightTime: 'Published duration not recorded in this evidence check; check the exact flight for your dates',
    frequency: 'London Gatwick\'s own live flight board names easyJet as a current operator, with at least two flights on a single day observed; exact frequency and dates vary',
    airlineSlugs: ['easyjet'],
    isDirect: true,
    verification: {
      status: 'verified',
      sourceName: "London Gatwick's own live flight-search system",
      sourceUrl: 'https://www.gatwickairport.com/flights?destination=D',
      verifiedDate: '2026-09-08',
      reviewDueDate: '2026-10-08',
      note: 'Route Verification 12 September final five (8 September 2026): resolves the stale-evidence problem flagged on 7 September -- Gatwick\'s own live flight-search system (the same system behind its public flight-status page), queried directly today, returns two live scheduled easyJet flights to Marrakech: EZY8705 (05:40) and EZY8709 (08:55), both North Terminal. This is real, current, operational flight-board evidence, not the 19 May 2025 static press release this record previously relied on, and confirms a genuinely current nonstop service is actually operating today, with easyJet named as the operator for the first time on real evidence (added to airlineSlugs). Classified RECENT/CHANGING (30-day window) -- a first-ever genuine continuity confirmation for this specific route, matching the treatment already used for the equivalent Leeds Bradford Turkey routes reverified the same day.',
    },
    airlineVerifications: [{
      airlineSlug: 'easyjet',
      status: 'verified' as const,
      ...
      verifiedDate: '2026-09-08',
      reviewDueDate: '2026-10-08',
      effectivePeriod: 'Live flights EZY8705 and EZY8709, 8 September 2026',
      supportedClaim: 'Operates at least two real, current, scheduled direct flights from London Gatwick to Marrakech on the same day, confirmed on the airport\'s own live flight-search system.',
      remainingUncertainty: 'Exact weekly frequency and duration are not stated by this source.',
    }],
    intro:
      'London Gatwick\'s own live flight board confirms current direct easyJet service to Marrakech, with more than one flight observed on the same day. Exact frequency and duration remain date-specific, so check the exact flight before booking. Trip.com does not currently provide an airport-specific dateless handoff for Gatwick.',
    bookingWindowNote:
      'This guide is route context, not a booking prediction. Check the exact service, duration, fare conditions and baggage terms before booking.',
    peakPeriodIds: [],
  },
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-10-04',
      note: 'Route Intelligence Freshness rolling-review Batch 3 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- 3h30m, Ryanair named as the current direct operator. easyJet\'s winter-2026 service (from a separate April 2026 announcement, not independently re-observed on the destinations page this session) is retained as previously recorded, not newly reconfirmed. Corrected on PR review (cadence validation) from an initial STABLE call to RECENT/CHANGING, then corrected again on a second PR review (4 September 2026 evidence-discipline check): the original rationale cited the destination page\'s own "Seasons: High = June-August; Low = November-February" field and an unsourced "genuinely mixed UK winter-sun/summer travel pattern" generalisation -- both withdrawn. The field is generic tourism content (proven via Birmingham\'s Istanbul page, a genuinely year-round route that carries the identical field), and the "mixed travel pattern" claim was never independently sourced, the same category of tourism-demand generalisation already rejected elsewhere in this project. The classification is unchanged, but now rests solely on a genuine, independent signal: easyJet\'s own winter-2026 service launch is a real, dated, operator-specific recent-launch fact, which the locked cadence policy explicitly treats as a RECENT/CHANGING trigger regardless of any tourism-season framing. Kept RECENT/CHANGING (30-day window) on this basis alone.',
    },
    intro:
  ...
  },
  {
    ...
    airportSlug: 'london-gatwick',
    destinationSlug: 'agadir',
    flightTime: 'Just under 4h (British Airways); check the exact flight for your dates',
    frequency: 'Current easyJet timetable shows bookable nonstop dates from late September through November 2026; British Airways also publishes direct Gatwick–Agadir service. Exact operating days vary',
    airlineSlugs: ['easyjet', 'british-airways'],
    isDirect: true,
    verification: {
      status: 'verified',
      sourceName: "easyJet's current London Gatwick–Agadir booking timetable, corroborated by British Airways' current Agadir route page",
      sourceUrl: 'https://stafftravel.easyjet.com/en/cheap-flights/London-Gatwick/Agadir',
      verifiedDate: '2026-09-08',
      reviewDueDate: '2026-10-08',
      note: 'Route Verification final seasonal/current-bookability attempt (8 September 2026): easyJet\'s current booking timetable lists bookable nonstop LGW–AGA flight 8703 on multiple dates from 29 September through 31 October 2026, with additional 8711 service shown on selected October dates. British Airways\' current Agadir route page independently says it flies direct from London Gatwick to Agadir and gives a just-under-four-hour flight time. This establishes current scheduled/bookable nonstop service while showing that operating days vary; exact weekly frequency is not inferred. Classified RECENT/CHANGING (30-day window) because the live timetable proves continuity but the route is date-specific and seasonal in its observed pattern. Trip.com remains unavailable for an airport-specific dateless handoff.',
    },
    airlineVerifications: [
      {
        airlineSlug: 'easyjet',
        status: 'verified' as const,
        sourceName: "easyJet's current London Gatwick–Agadir booking timetable",
        sourceUrl: 'https://stafftravel.easyjet.com/en/cheap-flights/London-Gatwick/Agadir',
        verifiedDate: '2026-09-08',
        reviewDueDate: '2026-10-08',
        effectivePeriod: 'Bookable nonstop flight 8703 on multiple dates 29 September–31 October 2026; flight 8711 also shown on selected October dates',
        supportedClaim: 'easyJet currently publishes bookable nonstop London Gatwick–Agadir service on selected dates.',
        remainingUncertainty: 'Exact weekly frequency and future operating dates are date-specific and may change.',
      },
      {
        airlineSlug: 'british-airways',
        status: 'verified' as const,
        sourceName: "British Airways' current Agadir route page",
        sourceUrl: 'https://www.britishairways.com/content/flights/morocco/agadir',
        verifiedDate: '2026-09-08',
        reviewDueDate: '2026-10-08',
        effectivePeriod: 'Current route page accessed 8 September 2026',
        supportedClaim: 'British Airways currently describes direct London Gatwick–Agadir service and a flight time just under four hours.',
        remainingUncertainty: 'The page does not state operating dates or frequency.',
      },
    ],
    intro:
      'Current easyJet and British Airways evidence supports direct London Gatwick–Agadir service, with easyJet publishing bookable dates from late September 2026. Exact operators, dates, frequency and duration vary by schedule, so check the specific flight before booking. Trip.com does not currently provide an airport-specific dateless handoff for Gatwick.',
    bookingWindowNote:
      'This guide is route context, not a booking prediction. Check the exact service, duration, fare conditions and baggage terms before booking.',
    peakPeriodIds: [],
  },
  {
    ...
    verification: {
      status: 'verified',
      sourceName: "Royal Air Maroc's current London–Casablanca booking page",
      sourceUrl: 'https://www.royalairmaroc.com/en_gb/flights-from-london-to-casablanca',
      verifiedDate: '2026-09-07',
      reviewDueDate: '2026-10-07',
      note: 'Route Verification Refresh, 12 September due-soon batch (7 September 2026): reconfirmed via the same primary source, still live. A genuine current LHR-CMN fare option still appears in the page\'s live fare calendar today, confirming Heathrow-Casablanca service continues to exist. A material new observation, however: Stansted (STN) and Gatwick (LGW) city-pair labels now appear far more often in the same live calendar (9 and 5 occurrences respectively, versus 1 for LHR, at a comparatively lower price point), which was not noted in the prior evidence and suggests Royal Air Maroc may now be prioritising other London airports over Heathrow for this route. Heathrow\'s own airline/terminal listing (the prior corroborating source) returned a 404 on every URL attempted this session and was not independently re-checked. Classified RECENT/CHANGING (30-day window) on the strength of this genuine relative-prominence shift across London airports -- not a contradiction of the Heathrow claim itself, but a real volatility signal worth a shorter review window.',
    },
    intro:
  ...
  },
  {
    ...
    verification: {
      status: 'verified',
      sourceName: "Manchester Airport's own media centre: \"A dozen new routes are launching from Manchester Airport this summer\" (mediacentre.manchesterairport.co.uk, 19 May 2026), re-checked live 14 September 2026",
      ...
      reviewDueDate: '2026-10-14',
      note: 'Route Verification Maintenance (14/15 September 2026, due-now batch): re-checked live this session — Manchester Airport\'s own destination material still supports the direct PIA service, with no suspension notice. This qualifying primary re-check supports refreshing verifiedDate/reviewDueDate for direct status. PIA\'s own site (piac.com.pk) returned a 403 to automated access this session, consistent with this airline\'s known bot-blocking pattern elsewhere in this file (e.g. Manchester–Karachi, Batch 3), so frequency remains genuinely unconfirmed and the public frequency field is left as-is. For awareness only, NOT as a basis for this record\'s verified frequency claim: multiple independent Pakistani aviation-press outlets (ProPakistani, Profit/Pakistan Today, Daily Times, The Nation, Daily Pakistan) report a weekly PK709/PK710 Boeing 777 service (PK710 Manchester Friday departure, PK709 Lahore Saturday departure) since the 3 July 2026 launch — this is secondary press coverage, not a qualifying primary source under this file\'s cadence policy (airline\'s own page, airport\'s own page, or an official newsroom notice only), and must not be read as confirming a route fact on its own. Classified RECENT/CHANGING (30-day window): a route still within its first year of operation.',
    },
  ...
  },
  {
    ...
    airlineVerifications: [
      ...
      },
      {
        ...
        status: 'verified',
        sourceName: 'Air India\'s own newsroom press release, "Air India elevates Mumbai-London Heathrow services with brand-new B787-9..." (airindia.com), dated 1 Jul 2026, corroborated 14 Sep 2026 by Heathrow\'s own live arrivals system showing flight AI131 scheduled and by independent flight-tracking data confirming AI131 operated on the route in September 2026',
        ...
        verifiedDate: '2026-09-14',
        reviewDueDate: '2026-12-13',
        effectivePeriod: 'Effective 1 Jul 2026 (press release\'s own effective date); re-corroborated 14 Sep 2026',
        supportedClaim: 'Confirms flights AI131/AI130 on the new Boeing 787-9, and explicitly states "Air India\'s second daily service between Mumbai and London Heathrow will continue to be served by its... Boeing 777-300ER" — i.e. two daily Air India flights, both named. Heathrow\'s own arrivals system (heathrow.com) independently lists AI131 as a scheduled Terminal 2 flight, re-checked this session.',
        remainingUncertainty: 'None significant — this is a dated, current, airline-issued primary source naming both daily flight numbers, now corroborated by Heathrow\'s own live schedule.',
      },
      {
        airlineSlug: 'virgin-atlantic',
        status: 'verified',
        sourceName: "Virgin Atlantic's own Mumbai destination page (virginatlantic.com/where-we-fly/asia/india/mumbai), re-checked live 14 Sep 2026",
        sourceUrl: 'https://www.virginatlantic.com/where-we-fly/asia/india/mumbai',
        verifiedDate: '2026-09-14',
        reviewDueDate: '2026-12-13',
        effectivePeriod: 'Current at access',
        supportedClaim: 'States directly: "Flights depart twice a day" from London Heathrow to Mumbai, flight time 8.5h — confirms 2x daily Heathrow–Mumbai, re-read live this session.',
  ...
  },
  {
    ...
    verification: {
      ...
      reviewDueDate: '2026-10-17',
      note: 'Route Verification Refresh Batch 1 (18 August 2026): Air India\'s own current booking route and its own newsroom press release both still identify London Gatwick (LGW) to Amritsar (ATQ) as a nonstop route (3x weekly, Boeing 787-8); no cancellation or suspension found. However, Air India\'s Gatwick India network is not currently stable — its sibling Gatwick-Ahmedabad service was found this same session to be temporarily inoperative, replaced by a Heathrow service, as part of Air India\'s wider "Safety Pause" operational adjustment (1 Aug-30 Sept 2026; see london-gatwick-ahmedabad\'s own record, left unrefreshed this batch). No evidence was found that Amritsar is specifically affected, but given the adjacent disruption on the same Gatwick-India network, this is classified RECENT / CHANGING rather than STABLE as a precaution — 30-day review window per the locked verification cadence policy, not the 90-day STABLE window. Due-date reverification (17 September 2026, Batch 6): the 18 August check\'s own cited booking-route URL, reopened fresh today, still shows the same self-contradicting template already documented on this route\'s sibling disputed pairs (london-gatwick-ahmedabad, birmingham-ahmedabad) — a structured "0 direct flights connect London and Amritsar" field alongside marketing copy that still says "fly directly", with no clear Gatwick-vs-Heathrow airport distinction anywhere on the page. That page alone is not treated as sufficient current evidence. The 27 March 2023 launch press release, while still live and uncontradicted, is HISTORICAL launch-announcement evidence and is not relied on alone to renew a September 2026 claim. Genuine current primary evidence was found instead: Air India\'s own 16 February 2026 newsroom press release on its Northern Summer Schedule 2026 product deployment, reopened and reread in full today, states under "From 01 August 2026" (already passed) that "Air India\'s flights to Birmingham from Amritsar and Delhi, and to London (Gatwick) from Ahmedabad and Amritsar will be operated with Air India\'s legacy B777-300ER, replacing the currently deployed legacy B787-8". This is current, dated, primary confirmation that the route\'s continued existence and Air India as the operator are both CURRENTLY SUPPORTED — but it also directly contradicts this record\'s own prior "Boeing 787-8" note, corrected here to B777-300ER. No current 2026 primary source (only the 2023 press release, historical-only) reconfirms the "3x weekly"/"Mon-Thu-Sat" frequency or operating-days detail, so that specificity is not restated as current fact — consistent with this route\'s own public frequency field, already deliberately hedged to "exact operating days vary" since the 28 July 2026 truth correction (see the resolved lgw-atq-reduced-frequency route-warning, data/route-warnings.ts). Gatwick Airport\'s own site was checked again this session; no route-specific Amritsar destination page exists there (404), consistent with the 18 August finding. Net effect: retained verified — direct-service-exists and Air India-operated are the two claims current primary evidence actually supports — with the stale aircraft detail corrected and the frequency/operating-days claim left unasserted rather than administratively renewed. No public-facing field required a wording change: flightTime/frequency/intro/bookingWindowNote were already appropriately hedged, named no specific frequency or aircraft, and remain truthful under this evidence; only this internal verification note (never publicly rendered) is corrected. Remains RECENT / CHANGING given the unresolved booking-page evidence-quality concern — 30-day review window per the locked verification cadence policy.',
    },
    intro:
  ...
  },
  {
    ...
    verification: { status: 'verified', sourceName: "Manchester Airport's official Barcelona destination guide", sourceUrl: 'https://www.manchesterairport.co.uk/destinations-and-guides/barcelona/', verifiedDate: '2026-09-04', reviewDueDate: '2026-10-04', note: 'Manchester Airport lists Barcelona as a direct destination and publishes a 2h30m flight-time planning figure. Exact operator, operating days and duration should be checked for the selected flight. Rolling Reverification Batch 4 (4 September 2026): reconfirmed via the same page, still live -- still lists Barcelona as a direct destination (tagged Beach, City Break, Sightseeing, Summer Sun) and its own text states Barcelona "fizzes all year round", not a summer-only claim. This session\'s render did not surface the 2h30m duration figure directly in page text, so that specific figure is carried forward unverified this pass rather than re-confirmed. No operator is named on this page, so no airline evidence exists either way. Kept RECENT / CHANGING (30-day window): route existence is reconfirmed, but with no named operator and no explicit stability signal, STABLE is not yet supported on the current evidence.' },
  ...
  },
  {
    ...
    flightTime: 'Approximately 2h 05m (Birmingham Airport)', frequency: 'Direct service; Birmingham Airport names easyJet, Jet2.com, Ryanair and Vueling as operators', airlineSlugs: ['easyjet', 'jet2'], isDirect: true,
    verification: { status: 'verified', sourceName: "Birmingham Airport's official Barcelona destination page", sourceUrl: 'https://airport.birminghamairport.co.uk/destinations/where-we-fly/barcelona/', verifiedDate: '2026-09-20', reviewDueDate: '2026-12-19', note: 'Astra2-B1 route-truth maintenance (20 September 2026): a genuine evidence upgrade over the prior generic destinations-listing check — Birmingham Airport\'s own dedicated Barcelona destination page, reopened live today, states "Airlines that fly direct: easyJet, Jet2.com, Ryanair and Vueling" and "Approximate flight time: 2 hours 05 minutes". easyJet and Jet2 are in the airline catalogue (data/airlines.ts) and are added to airlineSlugs; Ryanair and Vueling are not currently catalogued, so they are recorded here only, not added to public airlineSlugs — the same pattern already used on birmingham-faro and bristol-faro. The page\'s own "Seasons: High = March-August, Low = November-March" field is not treated as a seasonal-service signal — the identical field already appears on multiple confirmed year-round routes elsewhere in this file (see birmingham-faro\'s own note), so it is established generic tourism best-time-to-visit content, not flight-schedule evidence. With four confirmed current operators and no seasonal/volatility signal, reclassified STABLE (90-day window) per the locked verification cadence policy.' },
    intro: 'Birmingham Airport lists Barcelona as a direct destination, naming easyJet, Jet2.com, Ryanair and Vueling as operators. Exact operating day and duration vary by flight, so check the live schedule for your dates.',
  ...
  },
  {
    ...
    flightTime: 'Direct service listed by Bristol Airport; check the exact flight for duration', frequency: "Bristol Airport's own page states it flies all year round, daily (Mon-Sun), naming easyJet and Ryanair as operators", airlineSlugs: ['easyjet'], isDirect: true,
    verification: { status: 'verified', sourceName: "Bristol Airport's official Barcelona destination page", sourceUrl: 'https://www.bristolairport.co.uk/where-can-i-fly/destinations/europe/spain/barcelona', verifiedDate: '2026-09-20', reviewDueDate: '2026-12-19', note: 'Astra2-B1 route-truth maintenance (20 September 2026): a genuine evidence upgrade, matching the same pattern already established on this airport\'s own Faro record — Bristol Airport\'s own dedicated Barcelona destination page, reopened live today, states plainly "We fly: All year round" and "Flight days: Mon, Tue, Wed, Thur, Fri, Sat & Sun" (i.e. daily), with confirmed live booking links naming easyJet (flights and holidays) and Ryanair as operators. easyJet is in the airline catalogue (data/airlines.ts) and is added to airlineSlugs; Ryanair is not currently catalogued, so it is recorded here only, not added to public airlineSlugs/frequency copy — the same decision already made for bristol-faro. Exact duration is not stated on this page, so flightTime remains hedged rather than a new figure being invented. Reclassified STABLE (90-day window) on the airport\'s own explicit "all year round" and daily-frequency statement, per the locked verification cadence policy.' },
    intro: "Bristol Airport's own page says it flies direct to Barcelona all year round, daily, naming easyJet and Ryanair among its operators. Exact duration and the airline for your specific date still vary, so check the exact flight before booking.",
  ...
  },
  {
    ...
    verification: { status: 'verified', sourceName: "Leeds Bradford Airport's official direct destinations list", sourceUrl: 'https://www.leedsbradfordairport.co.uk/direct-destinations', verifiedDate: '2026-09-14', reviewDueDate: '2026-10-14', note: 'Route Verification Maintenance (14 September 2026, overdue batch): Leeds Bradford Airport\'s own destinations page, re-checked live this session, still lists Barcelona under its "City Breaks" category alongside 80+ other destinations. No specific operator or frequency figure could be independently corroborated this session, matching the prior check\'s depth — kept on RECENT/CHANGING (30-day window) rather than upgraded on unchanged evidence.' },
  ...
  },
  {
    ...
    flightTime: 'Direct service listed by Bristol Airport; check the exact flight for duration', frequency: "Bristol Airport's own page states it flies all year round, daily (Mon-Sun), with easyJet and Jet2.com; Ryanair is also named on the page but is not yet in JetStash's airline catalogue", airlineSlugs: ['easyjet', 'jet2'], isDirect: true,
    verification: {
      status: 'verified',
      sourceName: "Bristol Airport's official Faro destination page",
      sourceUrl: 'https://www.bristolairport.co.uk/where-can-i-fly/destinations/europe/portugal/faro',
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-12-03',
      note: 'Rolling Reverification Batch 5 (4 September 2026): a genuine evidence upgrade -- Bristol Airport\'s own page states plainly "We fly: All year round" and "Flight days: Mon, Tue, Wed, Thur, Fri, Sat & Sun" (i.e. daily), and names easyJet, Jet2.com and Ryanair as operators. easyJet and Jet2 are in the airline catalogue (data/airlines.ts) and are added to airlineSlugs; Ryanair is not currently catalogued, so it is recorded here only, not added to public airlineSlugs/frequency copy -- a separate decision, out of scope for a routine metadata refresh. Reclassified STABLE (90-day window) on the airport\'s own explicit "all year round" and daily-frequency statement.',
    },
    airlineVerifications: ['easyjet', 'jet2'].map((airlineSlug) => ({
      airlineSlug,
      status: 'verified' as const,
      sourceName: "Bristol Airport's official Faro destination page",
      sourceUrl: 'https://www.bristolairport.co.uk/where-can-i-fly/destinations/europe/portugal/faro',
      ...
      reviewDueDate: '2026-12-03',
      effectivePeriod: 'Current at access',
      supportedClaim: 'Named as flying direct from Bristol to Faro, all year round, on the airport\'s own destination page.',
      remainingUncertainty: 'Exact daily frequency split between operators and duration are not stated on this page.',
    })),
    intro: "Bristol Airport's own page says it flies direct to Faro all year round, daily, naming easyJet and Jet2.com among its operators. Exact duration and the airline for your specific date still vary, so check the exact flight before booking.",
  ...
  },
  {
    ...
    verification: { status: 'verified', sourceName: "Manchester Airport's official Faro destination guide", sourceUrl: 'https://www.manchesterairport.co.uk/destinations-and-guides/faro/', verifiedDate: '2026-09-14', reviewDueDate: '2026-10-14', note: 'Route Verification Maintenance (14 September 2026, overdue batch): reconfirmed via the same primary source, still live, still lists Faro as a direct destination with the same 3h planning figure. No operator was independently identified this session, matching the prior check\'s depth — kept on RECENT/CHANGING (30-day window) rather than upgraded on unchanged evidence.' },
  ...
  },
  {
    ...
    verification: { status: 'verified', sourceName: "Birmingham Airport's official Faro destination page", sourceUrl: 'https://airport.birminghamairport.co.uk/destinations/where-we-fly/faro/', verifiedDate: '2026-09-04', reviewDueDate: '2026-12-03', note: 'Route Intelligence Freshness rolling-review Batch 3 (4 September 2026): reconfirmed via the same primary source, still live -- names easyJet, Jet2.com and TUI (matching the existing record) plus Ryanair, not previously recorded here. Ryanair is not currently in the airline catalogue (data/airlines.ts), so it is noted here rather than added to the public airlineSlugs/frequency copy -- a separate decision, out of scope for a routine metadata refresh. The page states an approximate 1h50m flight time, but the existing "timings vary by source" framing is left unchanged rather than overwritten from a single reading, since that framing was deliberately chosen to reflect a genuine known discrepancy across sources. Corrected on PR review (cadence validation) from an initial STABLE call to RECENT/CHANGING, then corrected back on a second PR review (4 September 2026 evidence-discipline check): the page\'s own "Seasons: High = July-August; Low = November-February" field, initially treated as a genuine seasonal-service signal, was withdrawn after the identical field was found on Birmingham Airport\'s Istanbul page too -- a route confirmed STABLE via Turkish Airlines\' own explicit year-round statement -- proving it is generic tourism/best-time-to-visit content, not flight-schedule evidence. With that invalid signal removed, the remaining evidence (four confirmed current operators, established service, no recent launch/relaunch, suspension or other volatility signal) supports STABLE (90-day window).' },
  ...
  },
  {
    ...
    verification: { status: 'verified', sourceName: "Leeds Bradford Airport's own dedicated Faro/Algarve destination page", sourceUrl: 'https://www.leedsbradfordairport.co.uk/destinations/portugal/faro-algarve', verifiedDate: '2026-09-20', reviewDueDate: '2026-10-20', note: 'Astra2-B1 route-truth maintenance (20 September 2026): reconfirmed via a fresh, dedicated destination page (the prior source URL, the general direct-destinations list, no longer lists Faro under its curated highlight categories — Faro/Algarve was located instead via the site\'s full destinations index). The page groups Faro/Algarve alongside Porto under "We also fly direct to this other destination", consistent with continued direct-service listing, but names no operator, frequency or duration — no genuine evidence upgrade over the prior check\'s depth. Kept RECENT/CHANGING (30-day window) rather than upgraded on unchanged evidence, per the locked verification cadence policy.' },
  ...
  },
  {
    ...
    flightTime: 'Direct destination listed by Gatwick; approximately 3h; check the exact flight for duration', frequency: 'Gatwick destination information lists Faro; exact operators and frequency vary', airlineSlugs: [], isDirect: true,
    verification: { status: 'verified', sourceName: "London Gatwick's official destinations information", sourceUrl: 'https://www.gatwickairport.com/flights/destinations.html', verifiedDate: '2026-09-14', reviewDueDate: '2026-10-14', note: 'Route Verification Maintenance (14 September 2026, overdue batch): reconfirmed via the same primary source, still live, still lists Faro with a 3h flight time. No specific operator was independently identified this session, matching the prior check\'s depth — kept on RECENT/CHANGING (30-day window) rather than upgraded on unchanged evidence. Gatwick-specific affiliate continuation remains unavailable for this pair; no LON fallback is used.' },
  ...
  },
  {
    ...
    verification: { status: 'verified', sourceName: "Birmingham Airport's official Athens destination page", sourceUrl: 'https://airport.birminghamairport.co.uk/destinations/where-we-fly/athens/?searchresult=true', verifiedDate: '2026-09-04', reviewDueDate: '2026-12-03', note: 'Birmingham Airport lists direct Athens service, names Jet2 and gives an approximate 3h50m duration. Rolling Reverification Batch 5 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- Jet2 remains the sole named operator, 3h50m duration unchanged. Corrected on PR review (evidence-discipline check): the page also states "Seasons: High = June-September; Low = November-March", initially treated as a genuine seasonal-service signal -- but the identical field, in the identical position, appears on Birmingham Airport\'s Istanbul destination page too, a route independently confirmed STABLE via Turkish Airlines\' own explicit year-round statement. This proves the field is generic tourism/best-time-to-visit content applied uniformly across Birmingham\'s destination pages, not flight-schedule evidence, so it is withdrawn as a cadence signal here. A single confirmed operator alone is not disqualifying for STABLE (see the Batches 1-2 STABLE cadence consistency review), and no other volatility signal was found. Reclassified STABLE (90-day window).' },
    ...
    bookingWindowNote: 'Confirm operating dates, fare conditions and baggage terms before booking.', peakPeriodIds: [],
  },
  {
  ...
  },
  {
    ...
    verification: { status: 'verified', sourceName: "Birmingham Airport's official Rome destination page", sourceUrl: 'https://airport.birminghamairport.co.uk/destinations/where-we-fly/rome/', verifiedDate: '2026-09-04', reviewDueDate: '2026-12-03', note: 'Route Intelligence Freshness rolling-review Batch 3 (4 September 2026): reconfirmed via the same primary source, still live, matching exactly -- 2h35m, Jet2.com confirmed direct (matching the existing record), plus WIZZ and Ryanair named, not previously recorded here. Neither is currently in the airline catalogue (data/airlines.ts), so both are noted here rather than added to public copy -- a separate decision, out of scope for a routine metadata refresh. Corrected on PR review (cadence validation) from an initial STABLE call to RECENT/CHANGING, then corrected back on a second PR review (4 September 2026 evidence-discipline check): the original downgrade reasoned that no primary source affirmatively ruled out seasonal instability -- but that standard requires proving a negative and has since been rejected as too strict elsewhere in this project\'s own cadence consistency work (established scheduled service + no genuine volatility signal is sufficient; an explicit "rules out seasonality" statement is not required). This page also carries the same generic "Seasons: High/Low" field already shown (via Birmingham\'s Istanbul page) to be tourism content, not flight-schedule evidence, and is not relied on either way. With three confirmed current operators, an exact duration match, and no genuine volatility signal, this supports STABLE (90-day window).' },
  ...
  },
  {
    ...
    flightTime: 'Direct service listed by Bristol Airport; check the exact flight for duration', frequency: "Bristol Airport's own page states it flies all year round, up to 7 times a week, with easyJet", airlineSlugs: ['easyjet'], isDirect: true,
    verification: {
      status: 'verified',
      sourceName: "Bristol Airport's official Rome destination page",
      sourceUrl: 'https://www.bristolairport.co.uk/where-can-i-fly/destinations/europe/italy/rome',
      verifiedDate: '2026-09-04',
      reviewDueDate: '2026-12-03',
      note: 'Rolling Reverification Batch 5 (4 September 2026): a genuine evidence upgrade -- Bristol Airport\'s own page states plainly "We fly: All year round", "Fly up to 7 times a week" and "Flight days: Mon, Tue, Wed, Thur, Fri, Sat & Sun", naming easyJet as the operator. easyJet is in the airline catalogue (data/airlines.ts) and is added to airlineSlugs. No specific Rome airport (Fiumicino/Ciampino) is named on this page, so the existing "check the exact airport" caution is kept. Reclassified STABLE (90-day window) on the airport\'s own explicit "all year round" and up-to-7x-weekly statement.',
    },
    airlineVerifications: [
      {
        airlineSlug: 'easyjet',
        ...
        reviewDueDate: '2026-12-03',
        effectivePeriod: 'Current at access',
        supportedClaim: 'Named as flying direct from Bristol to Rome, all year round, up to 7 times a week, on the airport\'s own destination page.',
        remainingUncertainty: 'Exact Rome airport (Fiumicino/Ciampino), specific flight days and duration are not stated on this page.',
      },
    ],
    intro: "Bristol Airport's own page says it flies direct to Rome all year round, up to seven times a week, with easyJet. Rome can use more than one airport, so check the exact airport, duration and fare for your dates.",
