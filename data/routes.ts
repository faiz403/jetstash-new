...
export const routes: Route[] = [
  ...
  },
  {
    ...
    verification: {
      ...
      verifiedDate: '2026-08-12',
      reviewDueDate: '2026-09-12',
      note: 'Gatwick publishes direct Agadir service in its Africa route table. The reviewed evidence does not establish a fixed operator, duration or date pattern for every itinerary; Trip.com remains unavailable for an airport-specific dateless handoff. Rolling Reverification Batch 6 (4 September 2026) attempted an evidence upgrade, reading the same route table in full and finding "Agadir, Morocco -- EasyJet, British Airways, TUI -- 8 x weekly" -- but on final pre-merge evidence-freshness review this was withdrawn entirely: the source is a static press release independently dated 19 May 2025, and reopening the identical, unedited page in September 2026 does not establish that these operators or that frequency are still current -- it only proves the page still resolves. Recording a fresh 2026-09-04 verifiedDate against those specific operator/frequency facts would have been dating a historical claim as if it were current 2026 evidence, which is not supported. Reverted in full to the pre-Batch-6 record rather than keep a partially-corrected version -- no operator, frequency or airlineVerifications claim is made here until a genuinely current, live Gatwick source (not an archived press release) can be checked. Route Verification Refresh, 12 September due-soon batch (7 September 2026): a further fresh research attempt found no genuinely current, live Gatwick-specific source -- Gatwick\'s own "Browse all destinations" link now resolves to a third-party booking aggregator, and direct URL attempts at easyJet, TUI and British Airways Agadir-specific pages did not resolve. verifiedDate and reviewDueDate remain unchanged. Route Verification 12 September final five (8 September 2026): a further, genuinely live attempt was made -- Gatwick\'s own live flight-search system (the same system that successfully confirmed london-gatwick-marrakech the same day) was queried directly for "Agadir" and for the partial term "Agad", and returned zero matching flights today. This is a real negative result from a genuinely current source, not a repeat of the stale press release, but it does not positively confirm the route no longer operates -- an unmatched single day on a leisure route that may not fly daily is not proof of non-operation. Per policy, a route that cannot be reconfirmed is never administratively extended: verifiedDate and reviewDueDate remain unchanged, and this record is deliberately left to fail closed on its existing 2026-09-12 date rather than guessed either way.',
    },
    intro:
