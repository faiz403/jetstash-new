...
export const peakPeriods: PeakPeriod[] = [
  {
    ...
    description: 'The single sharpest demand spike on Pakistan and wider South Asia routes — fares rise fastest within 3–4 weeks of the date.',
  },
  {
    id: 'eid-al-adha',
    label: 'Eid al-Adha',
  ...
  },
  {
    ...
    category: 'religious',
    typicalMonths: 'Date shifts yearly (Islamic calendar)',
    description: 'Drives Umrah demand hard on Jeddah and Madinah routes specifically — pricing rises sharply in the weeks around it.',
  },
  {
    id: 'pre-hajj',
  ...
  },
  {
    ...
    description: 'A major nine-night festival specific to Gujarati and wider Hindu communities — drives demand on Ahmedabad services particularly hard.',
  },
  {
    id: 'baisakhi',
    label: 'Baisakhi',
    category: 'festival',
    typicalMonths: 'April',
    description: 'The Sikh harvest festival — the clearest annual demand spike on Amritsar routes alongside Diwali.',
  },
  {
    id: 'wedding-season',
    ...
    description: 'The South Asian wedding season — extended family travel and higher-than-usual baggage/booking volume across Pakistan and India routes.',
  },
  {
    ...
    description: 'UK school summer break — the most consistent demand spike across every region this site covers, not just South Asia.',
  },
  {
    ...
    description: 'UK Christmas/New Year school holidays — drives both outbound Gulf leisure travel and India/Pakistan family-visit travel timed around the break.',
  },
  {
