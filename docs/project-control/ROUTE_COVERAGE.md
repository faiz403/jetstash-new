...
| Manchester → Islamabad | Direct service verified through Manchester Airport; current frequency re-verified 12 September 2026 via live PK702 flight-tracking history (4x weekly, typical Mon/Tue/Thu/Sat pattern, presented as current-not-guaranteed). Review due 12 October 2026. | Recheck the pattern before the review date, and treat any change as a new dated check, not an edit to this one. |
